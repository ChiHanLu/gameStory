...
export const mockGames: Game[] = [
  {
    ...
    description: '在這個廣闊的海拉魯王國中，探索天空、大地和地底的秘密，體驗前所未有的冒險。',
    tags: ['冒險', '開放世界', '解謎'],
  ...
  },
  {
    ...
    description: '在夜城這個充滿霓虹燈的大都市中，成為傳奇網路駭客，體驗未來世界的黑暗與光明。',
    tags: ['RPG', '未來', '開放世界'],
  ...
  },
  {
    ...
    description: '5v5 戰術競技遊戲，選擇你的英雄，與團隊合作摧毀敵方水晶。',
    tags: ['MOBA', '競技', '團隊'],
  ...
  },
  {
    ...
    description: '開放世界冒險 RPG，在提瓦特大陸上與各種元素力量戰鬥，尋找失散的兄妹。',
    tags: ['RPG', '開放世界', '二次元'],
    category: GameCategory.RPG,
